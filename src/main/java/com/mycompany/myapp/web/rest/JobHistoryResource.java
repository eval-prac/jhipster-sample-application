...
public class JobHistoryResource {
    ...
    public ResponseEntity<JobHistory> updateJobHistory(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, jobHistory.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<JobHistory> partialUpdateJobHistory(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, jobHistory.getId())
        );
    }
