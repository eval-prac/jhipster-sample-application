...
public class LocationResource {
    ...
    public ResponseEntity<Location> updateLocation(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, location.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Location> partialUpdateLocation(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, location.getId())
        );
    }
